...
## This fork
This fork is fork enhancement parameter package_custom_modules. It adds functionality to package your custom module, that is not in your pipenv, but in sys.path or PYTHONPATH. Explanation is in settings list below. If you want to try this, just pip install timo-zappa and use command timo-zappa instead of zappa.
